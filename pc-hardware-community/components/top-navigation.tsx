        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-8">
            <div className="flex items-center space-x-4 cursor-pointer"
              ...
              <div
                className="w-14 h-8 bg-gradient-to-r from-blue-500 to-red-500 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-sm">PC</span>
              </div>
              <span
                className="text-xl font-bold bg-gradient-to-r from-blue-400 to-red-400 bg-clip-text text-transparent">
                하드웨어 커뮤니티
              </span>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-1">
              {navigationItems.map((item) => (
                <Button
                  ...
                  className={`flex items-center gap-2 px-3 py-2 rounded-lg ${activeSection === item.id
        ...
        <div className="flex overflow-x-auto px-4 py-2 space-x-1">
          {navigationItems.map((item) => (
            <Button
              ...
              size="sm"
              onClick={() => onSectionChange(item.id)}
              className={`flex items-center gap-2 px-3 py-2 rounded-lg whitespace-nowrap ${activeSection === item.id
                ? "bg-blue-500/20 text-blue-400 border border-blue-500/30"
                : "text-gray-300 dark:text-gray-300 hover:text-blue-400 dark:hover:text-blue-400"
                }`}
            >
